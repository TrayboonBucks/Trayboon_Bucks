...
const string strMessageMagic = "TrayboonBucks Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // TrayboonBucks: 1 day
static const int64 nTargetSpacing = 120; // TrayboonBucks: 2 min blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal trayboonbucks miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TrayboonBucks", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        //block.nTime    = 1366559428; ORIGINAL
